...
def test_last_page_multi():
    html = (
        '<a href="/names/letter/a/2">2</a>'
        '<a href="/names/letter/a/5">5</a>'
        '<a href="/names/letter/a/3">3</a>'
    )
...
def test_parse_simple_feminine():
    html = _name_entry("adalgund", "Adalgund", _fem(), _usage("Germanic"),
...
def test_parse_numbered_entries():
    ...
    html = (
        ...
        + _name_entry("ada-2", "Ada 2", '<span class="fem" title="feminine">f</span> &amp; <span class="masc" title="masculine">m</span>', _usage("Turkish"), "Turkish name.")
...
def test_strips_citations_from_description():
    html = _name_entry(
        "adalgund", "Adalgund", _fem(), _usage("Germanic"),
